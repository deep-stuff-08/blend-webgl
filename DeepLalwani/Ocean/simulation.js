...
var Simulator = function (canvas, width, height) {
	...
	var horizontalSubtransformProgram = buildProgramWrapper(gl, fullscreenVertexShader, horizontalSubtransformFrag, {'a_position': 0});
	...
	var verticalSubtransformProgram = buildProgramWrapper(gl, fullscreenVertexShader, verticalSubtransformFrag, {'a_position': 0});
	...
	var initialSpectrumProgram = buildProgramWrapper(gl, fullscreenVertexShader, initialSpectrumFrag, {'a_position': 0});
	...
	var phaseProgram = buildProgramWrapper(gl, fullscreenVertexShader, phaseFrag, {'a_position': 0});
	...
	var spectrumProgram = buildProgramWrapper(gl, fullscreenVertexShader, spectrumFrag, {'a_position': 0});
	...
	var normalMapProgram = buildProgramWrapper(gl, fullscreenVertexShader, normalMapFrag, {'a_position': 0});
	...
	var oceanProgram = buildProgramWrapper(gl, oceanVert, oceanFrag, {
			'a_position': 0,
