...
var Simulator = function (canvas, width, height) {
	...
	gl.uniform3f(gl.getUniformLocation(oceanProgram, 'u_oceanColor'), OCEAN_COLOR[0], OCEAN_COLOR[1], OCEAN_COLOR[2]);
	gl.uniform3f(gl.getUniformLocation(oceanProgram, 'u_skyColor'), SKY_COLOR[0], SKY_COLOR[1], SKY_COLOR[2]);
	gl.uniform3f(gl.getUniformLocation(oceanProgram, 'u_sunDirection'), SUN_DIRECTION[0], SUN_DIRECTION[1], SUN_DIRECTION[2]);
