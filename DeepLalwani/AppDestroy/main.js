...
var renderScene = SceneEnum.Tester
...
function render(time) {
	...
	case SceneEnum.Tester:
		// renderForExplosionDeep(perspectiveMatrix, cameraMatrix, mymodelmat, tex)
		testForAppDestroyDeep(perspectiveMatrix, cameraMatrix)
