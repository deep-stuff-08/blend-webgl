...
function setupProgramForAppDestroyDeep() {
	...
	var vertShader = createShader('rainbownoise.vert', gl.VERTEX_SHADER)
	var fragShader = createShader('rainbownoise.frag', gl.FRAGMENT_SHADER)
...
function initForAppDestroyDeep() {
	...
	appdestroyDeep.texInstagram = loadTexture('instagram.jpg', true)
	appdestroyDeep.texFacebook = loadTexture('facebook.jpg', true)
	appdestroyDeep.texYoutube = loadTexture('youtube.jpg', true)
	appdestroyDeep.texTinder = loadTexture('tinder.jpg', true)
