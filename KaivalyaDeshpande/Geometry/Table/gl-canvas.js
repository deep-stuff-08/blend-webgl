...
function initialize() {
    ...
    scene1_kvd_data.push(scene1_kvd_tempData[0]);
    scene1_kvd_data.push(scene1_kvd_tempData[1]);
...
function render() {
    ...
    scene1_kvd_drawTable(modelViewMatrix);
...
function uninitialize() {
    ...
    if(scene1_kvd_data[1] != null)
    {
        gl.deleteBuffer(scene1_kvd_data[1]);
        scene1_kvd_data[1] = null;
    }

    if(scene1_kvd_data[0] != null)
    {
        gl.deleteVertexArray(scene1_kvd_data[0]);
        scene1_kvd_data[0] = null;
    }
