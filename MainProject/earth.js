...
function initForDeepEarth() {
	...
	texDiffuseEarthLightForDeepEarth = loadTexture("resources/textures/earthlight.jpg", true)
	texDiffuseEarthNightForDeepEarth = loadTexture("resources/textures/earthnight.jpg", true)
}
