...
function setupProgramForExplosionDeep() {
	var vertShader = createShader('OpenCloseScene/shaders/explosion.vert', gl.VERTEX_SHADER)
	var fragShader = createShader('OpenCloseScene/shaders/explosion.frag', gl.FRAGMENT_SHADER)
